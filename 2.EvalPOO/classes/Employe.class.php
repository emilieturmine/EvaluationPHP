...
private $_enfant;
        ...
        public function setDateEmbauche($sDate) {  
               ...
               $this->_dateEmbauche = date_create_from_format ("d/m/Y",$sDate,);
        }
        ...
        public function getVersement(){
            ...
            return 'Le transfert d\'un montant de '. $this->calculerPrime() . ' € a été envoyé.';
                    }
                    else {
        ...
        public function getMontantChequeNoel() {
            ...
            return(string)  '<td>'.$this->_nom.
                            ...
                            '<td>'.  $this->calculerPrime().'</td>'.
                            '<td>'.  $this->getVersement().'</td>'.
                            '<td>'. $this->_agence.'</td>'.
                            '<td>'. $this->_restauration.'</td>'.
                            '<td>'. $this->isChequeVacance().'</td>'.
